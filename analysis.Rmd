...
- $H_0$: There is no correlation between low-carbon energy share and mortality 
  (rho = 0)
- $H_1$: Higher low-carbon share is associated with lower mortality (rho < 0)
...
- $H_0$: Coal and gas have equal effects on mortality (beta_coal = beta_gas)
- $H_1$: Coal has a stronger positive effect than gas (beta_coal > beta_gas)
...
- $H_0$: Nuclear energy share has no correlation with mortality (rho = 0)
- $H_1$: Nuclear energy share is negatively correlated with mortality (rho < 0)
...
# Groups: Low (<20%), Medium (20-40%), High (>40%)
#
# From course notes: ANOVA tests H0: mu_1 = mu_2 = ... = mu_k
# ============================================================================
...
for (yr in test_years) {
  ...
  cat(sprintf("Kruskal-Wallis: chi-square = %.4f, p = %.4f\n\n", 
...
# From course notes: "corrected p-values so probability of FP > 0 is <= alpha"
# ============================================================================
